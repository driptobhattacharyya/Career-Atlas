  ...
  return (
    <form onSubmit={handleSubmit(onFormSubmit)} className="space-y-8 text-left mt-6">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <Button
            ...
            variant="outline"
            size="sm"
            onClick={() => appendProject({ name: "", description: "", link: "", technologies: [] })}
          >
        ...
        {projectFields.map((field, index) => (
          <div
            key={field.id}
            className="relative rounded-xl border border-border p-4 bg-muted/20 space-y-4"
          >
            {index > 0 && (
              <Button
                type="button"
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  {...register(`projects.${index}.name` as const, { required: true })}
                />
              </div>
              <div className="space-y-1.5">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <Button
            ...
            variant="outline"
            size="sm"
            onClick={() => appendExp({ company: "", title: "", start_date: "", end_date: "" })}
          >
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <Button
            ...
            variant="outline"
            size="sm"
            onClick={() => appendEdu({ institution: "", degree: "", field_of_study: "" })}
          >
      ...
      <Button
        ...
        className="w-full h-12 rounded-full text-base bg-coral text-coral-foreground hover:bg-coral/90 shadow-warm"
      >
