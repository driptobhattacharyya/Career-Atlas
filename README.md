...
- **Deployment:** Backend on **AWS Lambda**, frontend on **Cloudflare Workers**, both auto-deployed from `prod` via GitHub Actions. See [`DEPLOYMENT_HANDOFF.md`](DEPLOYMENT_HANDOFF.md).
